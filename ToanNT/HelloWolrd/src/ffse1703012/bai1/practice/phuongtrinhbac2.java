...
///////////////////////////////////////////////////////////////
// Giải phương trình bậc hai một ẩn: a*(x*2) + b * x + c = 0 //
//////////////////////////////////////////////////////////////
...
public class phuongtrinhbac2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("----------------------------");
	 	...
	 	if(delta > 0) {
	 		System.out.println("Phương trình có hai nghiệm phân biệt X1= " + (-b+ Math.sqrt(delta))/(2*a) + " và X2= " + (-b- Math.sqrt(delta))/(2*a));
	 	}
	 	else if(delta < 0){
	 		System.out.println("Phương trình vô nghiệm!");
	 	}
